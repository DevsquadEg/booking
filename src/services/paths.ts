...
export const AD_EDIT_PATH = `${DASHBOARD_PATH}/ad-data/edit/:id`;
...
export const USER_DATA_PATH = `${DASHBOARD_PATH}/user-data/:id`;
...
const PATHS = {
  ...
  ROOM_DETAILS_PATH: ROOM_DETAILS_PATH.replace(MAIN_PATH, ""),
