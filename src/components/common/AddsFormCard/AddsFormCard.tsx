import { Box, Button, Dialog, FormHelperText, Grid, IconButton, TextField, Typography, Select, MenuItem } from "@mui/material";
...
import type { AddsRoom, CreateAddProps, CreateNewAddProps } from "@/interfaces/Adds.interface";
...
export default function AddsFormCard({ open, onClose ,title ,handleCreateNewAdd,error , selectedAdd ,handleUpdateCurrentAdd}: CreateNewAddProps) {
  ...
  useEffect(() => {
    async function fetchRooms() {
      try {
        const { data } = await axiosInstance.get(ADMIN_URLS.ROOM.GET_ALL_ROOMS_FOR_ADDS)
