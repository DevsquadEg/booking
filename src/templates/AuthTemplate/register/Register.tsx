import { Alert,  Container, FormControl, FormHelperText, Grid, IconButton, Input, InputAdornment, InputLabel, TextField, Typography } from "@mui/material";
...
export default function Register() {
  ...
  const { register, formState:{errors,isSubmitting} ,handleSubmit ,setValue ,control , watch, trigger} = useForm<IRegitserForm>(({ mode: "onChange" }));
...
// Function to handle form submission
  const onSubmitRegister = async (data: IRegitserForm) => {
    ...
    try {
      const response = await axiosInstance.post(PORTAL_URLS.USER.REGISTER, finalData);
        ...
        sx={
          {
            ...
            <Container maxWidth="sm">
              <AuhtHeader header={"Sign up !"} link={"Login here !"} caption={"If you already have an account register "} NavLink={"/Login"}/>
              <form onSubmit={handleSubmit(onSubmitRegister)}>
               ...
               {/* =================== User Name ===================== */}
                ...
                {...register("userName", { required: "User Name is required" })}
                            ...
                            {errors.userName && (   <Alert sx={{marginBottom:"1rem"}} severity="error">{errors.userName.message}</Alert>)}
                ...
                <TextField
                              ...
                              />
                             {errors.phoneNumber && (   <Alert sx={{marginBottom:"1rem"}} severity="error">{errors.phoneNumber.message}</Alert>)}
...
/>
  ...
  {errors.country && (   <Alert sx={{marginTop:"0.5rem", }} severity="error">{errors.country.message}</Alert>)}
                               </Box> </Box>
                              {/* =================== Email Address ===================== */}
                ...
                <TextField
                              ...
                              />
                             {errors.email && (   <Alert sx={{marginBottom:"1rem"}} severity="error">{errors.email.message}</Alert>)}
                      ...
                      <InputAdornment position="end">
                        ...
                        >
                          {showPassword ? <Visibility /> : <VisibilityOff />}{" "}
                              ...
                              />
                               {errors.password && (   <Alert sx={{marginBottom:"1rem"}} severity="error">{errors.password.message}</Alert>)}
                      ...
                      <InputAdornment position="end">
                        ...
                        >
                          {showPassword ? <Visibility /> : <VisibilityOff />}{" "}
                              ...
                              />
                              {errors.confirmPassword && (   <Alert sx={{marginBottom:"1rem"}} severity="error">{errors.confirmPassword.message}</Alert>)}
  ...
  >
    ...
    >
      <DeleteIcon color="error" fontSize="small" />
              ...
              {errors.profileImage && (   <Alert sx={{marginBottom:"1rem"}} severity="error">{errors.profileImage.message}</Alert>)}
