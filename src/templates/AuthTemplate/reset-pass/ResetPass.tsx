...
import type { ResetPasswordProps } from "../../../services/interfaces";
...
try {
  const options = {
    method: "POST",
    url:`${baseURL}/portal/users/reset-password`,
    data:userInfo
  }
            ...
            >
              ...
              >
                <OutlinedInput
                  ...
                  {...register("password", validation.PASSWORD_VALIDATION(watch("password")))}
                />
              </FormControl>
              {errors.password && (
